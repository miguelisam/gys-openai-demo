                    ...
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <img src={logo}
                                ...
                                height="178px"                            
                            />
                            <h1 className={styles.chatEmptyStateTitle}>Bienvenido al Asistente Virtual Inteligente del Gobierno del Perú</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>¿En que puedo ayudarte?</h2>
