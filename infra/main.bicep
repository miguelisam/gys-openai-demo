...
param appServicePlanName string = 'plan-gys-openai-demo'
param backendServiceName string = 'app-gys-openai-demo'
param resourceGroupName string = 'rg-gys-openai-demo'
